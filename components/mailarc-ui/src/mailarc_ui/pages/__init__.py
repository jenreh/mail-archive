...
it — ``accounts_list``, ``search_panel``, ``insights_panel``,
``explorer_panel``, ``embedder_panel``, ``status_panel`` — and never logic of
its own. A page that starts computing something is a panel that has not been
written yet.
"""
